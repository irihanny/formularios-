...
public class aplication {
        private static final Scanner leo=new Scanner(System.in);
        ...
        private static int opcion;
         public static void main(String[] args) throws SQLException {
                   ...
                   do{
                           ...
                           opcion=leo.nextInt();
                           switch (opcion) {
                        case 1 -> insertarProcedimiento() ;
                        case 2 -> editarProcedimiento() ;
                        case 3 -> eliminarProcedimiento();
                        case 4 -> mostrarProcedimiento();
